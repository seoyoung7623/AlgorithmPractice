...
# 하노이의 탑을 해결하는 재귀 함수
# n: 옮겨야 하는 원반의 수, start: n개의 원반이 있는 기둥, end: n개의 원반을 옮겨야 하는 기둥, via: n개의 원반을 start에서 end로 옮기기 위해 거치는 기둥
...
# 저장된 원반을 옮기는 과정을 그대로 구현해서, K번째 이동일 때의 막대마다 원반의 크기의 합을 구하면 된다.
